...
async function main() {
  ...
  console.log("🚀 Deploying ArcTaxTokenFactory...");
  ...
  console.log("\n⏳ Deploying ArcTaxTokenFactory contract...");
  ...
  console.log("\n✅ ArcTaxTokenFactory deployed successfully!");
  ...
  console.log("\n📝 Save to your .env:");
  console.log(`TAX_TOKEN_FACTORY_ADDRESS=${contractAddress}`);
